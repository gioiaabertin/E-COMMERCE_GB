...
<php lang="en">
                            ...
                            <li class="nav-item dropdown">
                                <!-- <select>
                                   ...
                                   // foreach ($result as $row) {
                                    //    echo ' <option><a href="shop.php?f="'.$row['id'].'">'. $row["nomeC"] . '</a></option>';
                                    //}
                                    ?>
  ...
  $result = DatabaseClassSingleton::getInstance()->Select('SELECT * FROM categorie');
  foreach ($result as $row) {
    echo '<option value="shop.php?f=' . $row['idC'] . '">' . $row["nomeC"] . '</option>';
  }
  ?>
                                </select>
                    ...
                    <div class=" navbar align-self-center d-flex">
                        ...
                        <form action="shop.php" method="GET">
                            <div class="input-group">
                                <input type="text" class="form-control" name="search" id="inputMobileSearch"
                                    placeholder="Search ...">
                                <button id='s' type="submit">Search</button>
                            </div>
