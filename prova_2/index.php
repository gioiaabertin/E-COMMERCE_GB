                ...
                <div class="align-self-center collapse navbar-collapse flex-fill  d-lg-flex justify-content-lg-between"
                    ...
                    <div class="flex-fill">
                        <ul class="nav navbar-nav d-flex justify-content-between mx-lg-auto">
                            ...
                            <li><a class="text-decoration-none" href="#">Prodotti</a></li>
                            <li><a class="text-decoration-none" href="#">Carello</a></li>
                            ...
                            <li><a class="text-decoration-none" href="#">Contatti</a></li>
                        </ul>
                    </div>
                        ...
                        <div class="row p-5">
                            ...
                            <div class="col-lg-6 mb-0 d-flex align-items-center">
                                <div class="text-align-left align-self-center">
                                    <h1 class="h1 text-success"><b>GB </b> shop</h1>
                                    <h3 class="h2">Tiny and Perfect eCommerce Template</h3>
                                    <p>
                                        Zay Shop is an eCommerce php5 CSS template with latest version of Bootstrap 5
                                        (beta
                                        1).
